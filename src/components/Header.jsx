    ...
    return (
        <header className="header">
            <div className="header__content">
                ...
                <div className='EmilyR'>
                    <div className='EmilyR_content'>
                        <div className='EmilyR_title'>Emily R</div>
                        <div className='EmilyR_title_p'>Project Manager, Bright Solutions</div>
                    </div>
