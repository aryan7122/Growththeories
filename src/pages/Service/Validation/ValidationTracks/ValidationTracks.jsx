...
import "./ValidationTracks.scss";
import cardImg from '../../../../assets/service/Business-inequality-cuate1.svg'
const ValidationTracks = () => {
    return (
        <div className="ValidationTracks">
            <div className="box-content-ValidationTracks">

                <div
                    className="box-content-ValidationTracks-content_box_header">
                    <div>
                        <h1 className="title">What Is Validation as a Service?</h1>
                        <p className="description">Validation as a Service (VaaS) is the process of testing business ideas, products, or strategies through data-driven experiments and user feedback. By validating early, you save time, reduce risks, and focus on the right growth opportunities</p>
                    </div>
                    <button className="cta_button"> Learn More About Our Approach</button>
                </div>
                        ...
                        <div className="cards">
                            <div className="card">
                                <div className="card_box_">
                                    ...
                                    <h3>Reduces risk by identifying flawed ideas before investing heavily</h3>
                                    <p>
                            ...
                            <div className="card">
                                <div className="card_box_">
                                    ...
                                    <h3>Allows you to pivot quickly based on real-time feedback</h3>
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur. Euismod nunc facilisis tortor
                                        risus non nisl viverra.
                                    </p>
                            ...
                            <div className="card">
                                <div className="card_box_">
                                    ...
                                    <h3>Saves time and resources by eliminating guesswork</h3>
                                    <p>
                                        Lorem ipsum dolor sit amet consectetur. Euismod nunc facilisis tortor
                                        risus non nisl viverra.
                                    </p>
                            ...
                            <div className="card ">
                                <div className="card_box_">
                                    ...
                                    <h3>Decrease budget waste</h3>
                                    <p>
                                        Testing whether a business idea will work before investing heavily can save companies from costly mistakes. Validating concepts through market research, prototyping, or small-scale experiments prevents businesses from building products or services that won’t resonate with their target audience. The phrase "If customers don’t come, don’t build it" emphasizes this point—if there's no demand or interest from your audience, pouring resources into development can lead to wasted time and money
                                    </p>
                                </div>
                                <button className="button_card">
                                    Contact Us <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" color="#3737b5" fill="none">
...
export default ValidationTracks;
