...
const data = [
  {
    ...
    description:
      "Used To Determine How Consumers Are Drawn To Retail Centers Based On Size And Distance.",
    image: image1,
  },
  {
    title: "Ehrenberg’s NBD-Dirichlet Model",
    description:
      "Describes Consumer Buying Patterns, Showing That Brand Loyalty And Purchase Frequency Follow A Predictable Probability Distribution.",
    image: image2,
  },
  {
    title: "The Law Of Double Jeopardy (DJ Law)",
    description:
      "States That Larger Brands Have Higher Market Share AND Higher Customer Loyalty Compared To Smaller Brands.",
    image: image3,
  },
  {
