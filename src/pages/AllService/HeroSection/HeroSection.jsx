...
import rocket from "../../../assets/allService/rocket.png";
    ...
    return (
        <div className="hero-section">
            <div className="hero-left">
                <button className="tag">GROWTH AGENCY IN INDIA</button>
                <h1>
                    Our Services For Growth Transformation In India <br />
                    <span>And Internationally.</span>
                </h1>
                <p>
                    Growththeories is a trusted development and growth marketing agency
                    in India. We help businesses of all sizes in India through our
                    research, design, development, and marketing services.
                </p>
