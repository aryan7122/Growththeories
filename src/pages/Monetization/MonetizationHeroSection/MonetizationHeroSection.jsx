...
import magnetImg from '../../../assets/monetization/monetization.svg'; // image ka correct path

const MonetizationHeroSection = () => {
    return (
        <div className="MonetizationHeroSection">
            <div className="hero-content">
                <p className="Subtitle">leading Agency in india</p>
                <h1>
                    Maximizing Profit:  <span>Strategies for Monetization and Revenue Growth</span>
                </h1>
...
export default MonetizationHeroSection;
