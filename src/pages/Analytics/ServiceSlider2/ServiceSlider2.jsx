...
import img1 from '../../../assets/Analytics/bwink_bld_04_single_08 1.svg'
...
const ServiceSlider2 = () => {
    ...
    return (
        <>
            ...
            <div className={styles.ServiceSlider2}>
                        ...
                        {sliderData.map((data) => (
                            <div className={styles.cardss} key={data.id}>
                                <div className={styles.card_lr}>
                                    ...
                                    <div className={styles.dataLR}>
                                        <div className={styles.data_l}>
                                            <motion.h3
