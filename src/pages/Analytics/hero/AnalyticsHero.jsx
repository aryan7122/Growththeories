...
import './AnalyticsHero.scss';
import Analytics from '../../../assets/Analytics/Analytics.svg'

const AnalyticsHero = () => {
    return (
        <div className="AnalyticsHero-section">
            <p className="subheading">leading Agency in india</p>
            <h1 className="main-heading">
                Boosting business success with  <br />
                <strong>
                    growth approved Analytics services
                </strong>
            </h1>
            ...
            <div className="img_activation">
                <img src={Analytics} className='img_' alt="Essential Strategies img" />
            </div>
        </div>
    );
};
